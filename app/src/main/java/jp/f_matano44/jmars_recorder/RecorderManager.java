...
final class RecorderManager {
    ...
    // MARK: Variable
    static final RecorderBody recorderBody = new RecorderBody();
    ...
    // MARK: Recorder body class
    static final class RecorderBody implements Cloneable {
        // static variables
        ...
        // MARK: Method(s)
        @Override public RecorderBody clone() throws CloneNotSupportedException {
